...
public class ItemList
{
    ...
    //Raw
    public static Item itemRawAdamantine;
    public static Item itemRawAldourite;
    public static Item itemRawAluminum;
    public static Item itemRawAmericium;
    public static Item itemRawAmordrine;
    public static Item itemRawAngmallen;
    public static Item itemRawAstralSilver;
    public static Item itemRawAtlarus;
    public static Item itemRawBismuth;
    public static Item itemRawBlackSteel;
    public static Item itemRawCadmium;
    public static Item itemRawCarmot;
    public static Item itemRawCelenegil;
    public static Item itemRawCeruclase;
    public static Item itemRawChromium;
    public static Item itemRawCobalt;
    public static Item itemRawCopper;
    public static Item itemRawDeepIron;
    public static Item itemRawDesichalkos;
    public static Item itemRawEximite;
    public static Item itemRawGallium;
    public static Item itemRawHaderoth;
    public static Item itemRawHepatizon;
    public static Item itemRawIgnatius;
    public static Item itemRawIndium;
    public static Item itemRawInfuscolium;
    public static Item itemRawInolashite;
    public static Item itemRawIridium;
    public static Item itemRawKalendrite;
    public static Item itemRawLead;
    public static Item itemRawLemurite;
    public static Item itemRawManganese;
    public static Item itemRawMeutoite;
    public static Item itemRawMidasium;
    public static Item itemRawMithril;
    public static Item itemRawMolybdenum;
    public static Item itemRawNeodymium;
    public static Item itemRawNeptunium;
    public static Item itemRawNickel;
    public static Item itemRawNiobium;
    public static Item itemRawOrichalcum;
    public static Item itemRawOsmium;
    public static Item itemRawOureclase;
    public static Item itemRawPalladium;
    public static Item itemRawPlatinum;
    public static Item itemRawPlutonium;
    public static Item itemRawPolonium;
    public static Item itemRawPromethium;
    public static Item itemRawRhenium;
    public static Item itemRawRhodium;
    public static Item itemRawRuthenium;
    public static Item itemRawRubracium;
    public static Item itemRawSanguinite;
    public static Item itemRawShadowIron;
    public static Item itemRawSilver;
    public static Item itemRawTantalum;
    public static Item itemRawTartarite;
    public static Item itemRawTechnetium;
    public static Item itemRawThallium;
    public static Item itemRawTin;
    public static Item itemRawTitanium;
    public static Item itemRawTungsten;
    public static Item itemRawUnobtainium;
    public static Item itemRawUranium;
    public static Item itemRawVanadium;
    public static Item itemRawVulcanite;
    public static Item itemRawVyroxeres;
    public static Item itemRawYellorite;
    public static Item itemRawZinc;
    public static Item itemRawZirconium;
    //Gems
